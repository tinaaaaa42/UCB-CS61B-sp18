...
public class MemoryGame {
    ...
    public void startGame() {
        ...
        while (!gameOver) {
            ...
            // generates a random string whose length equals to round
            String string = generateRandomString(round);

            // display the string letter by letter
            ...
            // check
            if (playerInput.equals(string)) {
                drawFrame("Correct! Next Level!");
                StdDraw.pause(1000);
                round += 1;
            } else {
                gameOver = true;
                drawFrame("Wrong! Final Level: " + round);
            }
        }
